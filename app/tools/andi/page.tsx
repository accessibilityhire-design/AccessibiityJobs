...
export const metadata: Metadata = {
  title: 'ANDI Guide 2025 - Accessibility Testing Tool',
  description: 'Complete ANDI guide: features, how to use, best practices, and integration for accessibility testing workflows.',
  keywords: ['ANDI', 'accessibility testing', 'accessibility tools'],
  ...
  return (
    <div className="container mx-auto px-4 py-12">
      ...
      <div className="max-w-4xl mx-auto">
        ...
        <Card className="mb-8"><CardHeader><CardTitle>Overview</CardTitle></CardHeader><CardContent><p className="text-gray-700">ANDI is a powerful accessibility testing tool used by professionals worldwide. Essential for comprehensive accessibility testing and WCAG compliance validation.</p></CardContent></Card>
